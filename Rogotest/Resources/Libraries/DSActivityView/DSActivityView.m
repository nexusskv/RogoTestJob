...
{
    return [self newActivityViewForView:addToView withLabel:NSLocalizedString(@"Loading...", "") width:0];
}
...
- (UILabel *)activityLabel;
{
    if (!_activityLabel)
    {
        ...
        _activityLabel.textAlignment = [[Helper shared] getTextAlignByiOSVersFromTag:TEXT_ALIGN_LEFT_TAG];
...
- (UILabel *)activityLabel;
{
    if (!_activityLabel)
    {
        ...
        _activityLabel.textAlignment = [[Helper shared] getTextAlignByiOSVersFromTag:TEXT_ALIGN_CENTER_TAG];
        _activityLabel.textColor = [UIColor whiteColor];
        _activityLabel.backgroundColor = [UIColor clearColor];
    }
...
{
    return [self newActivityViewWithLabel:NSLocalizedString(@"Loading...", "")];
}
